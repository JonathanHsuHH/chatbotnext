...
export function MainFrame() {
  ...
  const defaultPluginConfig: PluginConfig = {usePromptSuggestion: false, useSearch: false, useDeepSeek: true, searchEngine: SearchEngineEnum.Bing, searchResultNum: 3/*, useGPT4: false*/}
