...
export const LoadingChatLine = ({loadingMsg} : any) => (
...
// loading placeholder animation for the chat line
export const ErrorMsgChatLine = ({errorMsg} : any)=> {
  return (
  <div className="text-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded flex" role="alert">
